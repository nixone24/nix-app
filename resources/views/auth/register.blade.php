...
@section('content')
  ...
  <div class="col-6"><input type="text" class="form-control rounded-pill" placeholder="Prénom" /></div>
            ...
            <input type="email" class="form-control mb-3 rounded-pill" placeholder="Email" />
            <input type="date" class="form-control mb-3 rounded-pill" placeholder="Date de naissance" />
             <input type="password" class="form-control mb-3 rounded-pill" placeholder="Mot de passe" />
            <input type="password" class="form-control mb-3 rounded-pill" placeholder="Répète mot de passe" />
